...
function showJoin(){const expired=Date.now()>=Date.parse('2026-09-29T00:00:00+08:00');open(`<article class="detail-inner"><p class="eyebrow">2026 AUTUMN RECRUITMENT</p><h2 id="detail-title">下一段探索，<br>与你一起。</h2><p class="detail-text">欢迎建筑、规划、风景园林、土木等相关专业的大一、大二同学。带着学习热情与合作精神，在简维一起尝试、交流和成长。</p><section class="growth-plan"><h3>在简维，逐步找到自己的方向</h3><p>根据工作室成长计划，参与内容随学习阶段和个人准备情况安排。</p><ol><li><strong>大一 · 基础与尝试</strong><span>从手绘、立体构成和初识建筑等练习开始，了解创新创业类竞赛。</span></li><li><strong>大二 · 研究与协作</strong><span>参与大创、挑战杯、节能减排等方向的学习与合作，准备建筑与 BIM 设计竞赛。</span></li><li><strong>大三 · 设计与深化</strong><span>围绕建筑设计和 BIM 等方向继续深化，选择适合自己的项目与竞赛。</span></li></ol></section><div class="join-date">10.08 — 10.09</div><p class="detail-text">面试地点：致用楼 101<br>日常工作室：三立园负一层 U创长廊</p><p class="detail-meta">加入招新群，留意群内安排并参加面试。面试具体时段以群内通知为准。</p><div class="qr-grid"><section><h3>招新微信群</h3>${expired?'<p class="expired">本期群二维码已到期，请联系负责人获取最新入群方式。</p>':'<div class="qr-frame group"><img src="assets/recruitment-qr-20260922.png" alt="26 简维工作室秋季招新群二维码"></div><p>群二维码有效至 2026 年 9 月 29 日前。<br>若无法加入，请联系负责人。</p><a class="qr-full" href="assets/recruitment-qr-20260922.png" target="_blank" rel="noopener">查看 / 保存完整二维码 ↗</a>'}</section><section><h3>负责人微信</h3><div class="qr-frame manager"><img src="assets/manager-qr.png" alt="负责人微信高清二维码"></div><p>咨询工作室、面试与入群事宜。</p><a class="qr-full" href="assets/manager-qr.png" target="_blank" rel="noopener">查看 / 保存负责人高清二维码 ↗</a></section></div><div class="about-grid"><section><h3>一起学习</h3><p>共享学习空间，参与设计交流，<br>在模型制作与数字工具练习中积累经验。</p></section><section><h3>一起成长</h3><p>参与适合自己的竞赛与实践，<br>与工作室伙伴分享经验、相互支持。</p></section></div></article>`)}
